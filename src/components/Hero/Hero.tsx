const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen max-sm:p-5  text-white bg-[url('/assets/heroimage.webp')] bg-cover bg-center max-w-screen max-h-150 max-md:max-h-110 max-sm:max-h-96">
