...
const Footer = () => {
  return (
    <footer className="flex bg-neutral-cinzamedio text-primary-azulprofundo  w-full sm:h-[66px] max-sm:pb-10 text-center justify-evenly align-center flex-row gap-4  max-sm:flex-col">
